...
def train(train_dataset, step_size, device):
...
if __name__ == '__main__':
    ...
    total_iterations, iteration_loss, iteration_accuracy = train(train_dataset, 32, device)
    ...
    # Save the figure
    plt.savefig('q3-3.png', dpi=300, bbox_inches='tight')
    plt.show()